...
class ImageEnv2(gym.Env):
	...
	def _createWorld(self):
		...
		boxfix = self.box.CreatePolygonFixture(density=1, box=(0.5,1), friction=0.5)
	...
	def step(self, action):
		...
		if not self.done:
			...
			obs = np.array(pygame.surfarray.array3d(self.screen)).reshape(240 * 180 * 3, )
